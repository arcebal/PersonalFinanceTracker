    ...
    <div class="page-shell">
        <section class="page-header">
            <div class="page-title-block">
                ...
                <p class="page-subtitle">Use categories to keep reports readable and budgets accurate across income and
                    expense entries.</p>
            </div>
            <div class="page-actions">
                <a href="{{ route('categories.trashed') }}" class="btn-secondary" title="View trash">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="table-badge"
                                            style="border-color: {{ $cat->color }}33; background-color: {{ $cat->color }}1f; color: {{ $cat->color }};">
