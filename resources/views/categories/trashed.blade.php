    ...
    <div class="page-shell">
        <section class="page-header">
            <div class="page-title-block">
                ...
                <p class="page-subtitle">Restore archived categories or remove them permanently if they are no longer needed.
                </p>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="table-badge"
                                            style="border-color: {{ $c->color }}33; background-color: {{ $c->color }}1f; color: {{ $c->color }};">
                                        ...
                                        <div class="table-actions">
                                            ...
                                            <form action="{{ route('categories.forceDelete', $c->id) }}" method="POST">
                                                ...
                                                <button onclick="return confirm('Permanently delete?')"
                                                    class="btn-danger">Delete permanently</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <div class="empty-icon">
                        <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M6 7h12m-9 4v6m6-6v6M8 7l1-2h6l1 2m-9 0v11a2 2 0 002 2h6a2 2 0 002-2V7" />
                        </svg>
                    </div>
