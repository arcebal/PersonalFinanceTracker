            ...
            <div class="form-panel">
                <div class="panel-heading mb-6">
                    <div class="panel-title-block">
                        ...
                        <p class="panel-subtitle">Use clear names so this account is easy to identify during transaction
                            entry.</p>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('accounts.store') }}" class="auth-form">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-field md:col-span-6">
                            ...
                            <input type="number" name="balance" value="{{ old('balance', 0) }}" step="0.01"
                                min="0">
                            @error('balance')
                                <p class="text-sm text-expense">{{ $message }}</p>
                            @enderror
